    ...
    if(localStorage.getItem("group") === `"geography"`){
      ...
      function fan (type1,type2,type3,type4,type5){ 
        if(localStorage.getItem(type1) === type2){
          ...
          select.children[0].textContent = "محاضرات pdf";
      ...
      pdf.addEventListener("click",()=>{
        ...
        for (let v = 0; v < 21 ; v++){
         ...
         fan(`spject7`,` فرص العمل التشاركي`,jsonData["level1_G&H"].spj1[`L_Pdf${v}`],jsonData["level1_G&H"].spj1[`T_PDF${v}`],7);
         fan(`spject8`,`مبادي الاقصاد `,jsonData["level1_G&H"].spj7[`L_Pdf${v}`],jsonData["level1_G&H"].spj7[`T_PDF${v}`],8);
         fan(`spject9`,`الصحه النفسيه لطفل المرحله الابتدائيه`,jsonData["level1_G&H"].spj8[`L_Pdf${v}`],jsonData["level1_G&H"].spj8[`T_PDF${v}`],9); 
         fan(`spject10`,`سكشن العمليات الرياضيه الاساسيه`,jsonData["level1_G&H"].spj9[`L_Pdf${v}`],jsonData["level1_G&H"].spj9[`T_PDF${v}`],10);
         fan(`spject11`,`سكشن مهارات تواصل باللغه العربيه 1`,jsonData["level1_G&H"].spj10[`L_Pdf${v}`],jsonData["level1_G&H"].spj10[`T_PDF${v}`],11); 
         fan(`spject12`,`التفكير العلمي الفلسفي`,jsonData["level1_G&H"].spj11[`L_Pdf${v}`],jsonData["level1_G&H"].spj11[`T_PDF${v}`],12);
         fan(`spject13`,`مهارات تواصل باللغه العربيه 2`,jsonData["level1_G&H"].spj12[`L_Pdf${v}`],jsonData["level1_G&H"].spj12[`T_PDF${v}`],13); 
         fan(`spject14`,`سكشن مهارات تواصل باللغه العربيه 2`,jsonData["level1_G&H"].spj13[`L_Pdf${v}`],jsonData["level1_G&H"].spj13[`T_PDF${v}`],14);
           //مواد المستوي الثاني
